(function () {
    ...
    function trend3Controller($http, echartsDraw, $scope) {
        ...
        jQuery.get('authorsByYear(0.8).json', function (data) {
            ...
            echartsDraw.draw('main3', data, 'author name', 'Top authors of year');
            ...
            jQuery.get('authorByConference(0.8).json', function (data) {
                ...
                echartsDraw.draw('main4', data, 'author name', 'Top authors of conference');

                jQuery.get('citationByYear(0.8).json', function (data) {
                    vm.citationByYear = data;
                    echartsDraw.draw('main1', vm.prepareCitationByYear(vm.citationByYear, vm.top1, vm.year1), 'paper title', 'Top citations of year');
                    ...
                    jQuery.get('citationByConference(0.8).json', function (data) {
                        ...
                        echartsDraw.draw('main2', data, 'paper title', 'Top citations of conference');
